      ...
      <div className="max-w-3xl mx-auto">
        ...
        <form className="flex items-center justify-center gap-4 flex-wrap">
          <div className="flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden">
            ...
            />
            <Button className="bg-teal-400 dark:bg-cyan-700 text-white px-6 py-3 rounded-r-full hover:bg-teal-800 dark:bg-cyan-800">
              Search
            </Button>
          </div>

          <Button className="bg-white dark:bg-gray-800 text-teal-600 rounded-full hover:bg-gray-200 px-6 py-3 shadow">
            Explore Courses
          </Button>
        </form>
      </div>
